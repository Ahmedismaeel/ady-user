                    ...
                    Expanded(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          widget.orderDetailsModel!.date == null
                              ? SizedBox.shrink()
                              : const SizedBox(
                          ...
                          widget.orderDetailsModel!.date == null
                              ...
                              : Row(
                                  children: [
                                    Text(
                                        getTranslated('Selected Date', context),
                                        style: titilliumRegular.copyWith(
                                            color:
                                                Theme.of(context).hintColor)),
                                    Text(': ${widget.orderDetailsModel!.date}',
                                        style: titilliumRegular.copyWith(
                                            color: ColorResources.hintTextColor,
                                            fontSize: 14)),
                                  ],
                                ),
                          widget.orderDetailsModel!.time == null
                              ? SizedBox.shrink()
                              : const SizedBox(
                                  height: Dimensions.paddingSizeExtraSmall),
                          widget.orderDetailsModel!.time == null
                              ...
                              : Row(
                                  children: [
                                    Text(
                                        getTranslated('Selected Time', context),
                                        style: titilliumRegular.copyWith(
                                            color:
                                                Theme.of(context).hintColor)),
                                    Text(': ${widget.orderDetailsModel!.time}',
                                        style: titilliumRegular.copyWith(
                                            color: ColorResources.hintTextColor,
                                            fontSize: 14)),
                                  ],
