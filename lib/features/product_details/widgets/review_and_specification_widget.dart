...
class ReviewAndSpecificationSectionWidget extends StatelessWidget {
  final Function setReview;
  final bool isReview;
  const ReviewAndSpecificationSectionWidget(
      {super.key, required this.setReview, required this.isReview});
      ...
      return Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            InkWell(
              onTap: () => setReview(
                  false), //productDetailsController.selectReviewSection(true),
              child: Stack(
