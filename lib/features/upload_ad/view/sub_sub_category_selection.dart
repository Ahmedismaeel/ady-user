...
class SubSubCategoryListWidget extends ConsumerWidget {
  final List<SubSubCategory> list;
  const SubSubCategoryListWidget({
    super.key,
    required this.list,
  });
  ...
  Widget build(BuildContext context, ref) {
    return Scaffold(
      appBar: CustomAppBar(
        title: "Select SubSubCategory".translate(context),
      ),
      bottomNavigationBar: Container(
        ...
        child: CustomButton(
            ...
            onTap: () {
              const CategoryFieldsView().launch(context);
            }),
      ),
      body: Container(
        padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 12),
        child: ListView.builder(
          ...
          itemBuilder: (BuildContext _, int index) {
            ...
            return Container(
              ...
              ref
                  .read(subSubcategoryIdProvider.notifier)
