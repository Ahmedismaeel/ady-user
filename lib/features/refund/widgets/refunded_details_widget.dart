  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(
        ...
        // showActionButton: true,showResetIcon: true, reset:
      ),
      body: Column(
        children: [
                                            ...
                                            child: Container(
                                                ...
                                                decoration: BoxDecoration(
                                                    ...
                                                    border: Border.all(
                                                        color: Colors.green,
                                                        width: 1)),
                                                child: refund.refundResultModel !=
                                                        null
                                                    ? Text(getTranslated("${refund.refundResultModel!.refundRequest![0].status}", context),
                                                        style: textBold.copyWith(
                                                            fontSize: Dimensions
                                                                .fontSizeDefault,
                                                            color: Colors.green))
