...
class ProductRepository implements ProductRepositoryInterface {
  ...
  Future<ApiResponse> getFilteredProductList(BuildContext context,
    ...
    try {
      final response = await DioClient.instance.get(endUrl + offset);
  ...
  Future<ApiResponse> getBrandOrCategoryProductList(
    ...
    try {
      ...
      final response = await DioClient.instance.get(uri);
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  Future<ApiResponse> getRecommendedProduct() async {
    try {
      final response = await DioClient.instance.get(AppConstants.dealOfTheDay);
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  Future<ApiResponse> getMostDemandedProduct() async {
    try {
      final response =
          await DioClient.instance.get(AppConstants.mostDemandedProduct);
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  Future<ApiResponse> getFindWhatYouNeed() async {
    try {
      final response =
          await DioClient.instance.get(AppConstants.findWhatYouNeed);
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  Future<ApiResponse> getJustForYouProductList() async {
    try {
      final response = await DioClient.instance.get(AppConstants.justForYou);
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  Future<ApiResponse> getHomeCategoryProductList() async {
    try {
      final response =
          await DioClient.instance.get(AppConstants.homeCategoryProductUri);
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
