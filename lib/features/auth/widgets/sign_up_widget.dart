...
class SignUpWidgetState extends State<SignUpWidget> {
  ...
  final FocusNode _persionalIdFoucus = FocusNode();
                ...
                children: [
                  ...
                  Container(
                      margin: const EdgeInsets.only(
                          ...
                          top: Dimensions.marginSizeSmall),
                      child: CustomTextFieldWidget(
                        hintText: "Personal ID".translate(context),
                        labelText: "Personal ID".translate(context),
                        focusNode: _persionalIdFoucus,
                        prefixIcon: Images.cPolicy,
                        ...
                        onTap: authProvider.isAcceptTerms
                            ? () {
                                ...
                                if (signUpFormKey.currentState?.validate() ??
                                  ...
                                  register.personalId = personalId;
                                  register.referCode =
