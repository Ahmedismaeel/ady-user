...
class CouponRepository implements CouponRepositoryInterface {
  ...
  Future<ApiResponse> get(dynamic coupon) async {
    try {
      final response =
          await DioClient.instance.get('${AppConstants.couponUri}$coupon');
  ...
  Future<ApiResponse> getList({int? offset}) async {
    try {
      final response =
          await DioClient.instance.get('${AppConstants.couponListApi}$offset');
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  Future<ApiResponse> getAvailableCouponList() async {
    try {
      final response =
          await DioClient.instance.get(AppConstants.availableCoupon);
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
