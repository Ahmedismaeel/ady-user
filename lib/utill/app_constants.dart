...
class AppConstants {
  static const String appName = 'Ady';
  ...
  static const String createAd = '/api/v1/ads/add';
  static String expiredAd({required int? category, required int status}) =>
      category == null
          ? "/api/v1/ads/myads/expired/$status"
          : '/api/v1/ads/myads/expired/$status/$category';
  static const String updateAdStatus = '/api/v1/ads/status-update';
  static String updateAd({required int id}) => '/api/v1/ads/update/$id';
  static const String addAdFields = '/api/v1/ads/ad/field';
  static String getAdField(int id) => "/api/v1/ads/field/values/$id?guest_id=1";
  static const String myAds = "/api/v1/ads/myads";
  static const String adList = '/api/v1/ads/list';
  static String bestSellingVendor(int sellerId) =>
      '/api/v1/seller/$sellerId/seller-best-selling-products';
  static const String orderPayment = '/api/v1/payment/pay/';
  static const String adFilter = '/api/v1/ads/filter';
  static const String checkPayment = '/api/v1/payment/callback';
  static const String checkPaymentOrder = '/api/v1/payment/callback_order';
  static const String assingProductToPlan =
      '/api/v1/plans/subscribe/ads/myplan';
  static String editAdHelper(int? id) => '/api/v1/ads/edit/$id';
  static const String adsByAdvertiser = "/api/v1/items/ader_ads";
  static const String searchAd = '/api/v1/items/filter';
  static const String getViews = '/api/v1/ads/myads_clicks';
  static const String governorateList = '/api/v1/items/governorates';
  static String wilayaList(int id) => '/api/v1/items/wilyat_by_gov_id/$id';
  static const String planList = '/api/v1/plans/all';
  static String planByCategoryId(int id, int type) =>
      '/api/v1/plans/list/$type/$id';
  static String subscribePlane({required planId}) =>
      '/api/v1/plans/subscribe/$planId';
  static String becomeASeller({required planId}) =>
      '/api/v1/plans/seller_subscribe/$planId';
  static String planListByType(int id) => '/api/v1/plans/list/$id';
  static const String myPlan = '/api/v1/plans/my-plans/1';
  static const String uploadImage = "/api/v1/ads/upload-images";
  static String categoryFields(int id) => '$baseUrl/api/v1/fields/list/$id';
  static String fieldValues(int id) => '/api/v1/fields/values/$id';

  static const String shopByLocation = "/api/v1/items/shops_filter";
  ...
  static const String removeCart = "/api/v1/cart/remove-all";
  ...
  // sharePreference
  static const String userLoginToken = 'userToken';
