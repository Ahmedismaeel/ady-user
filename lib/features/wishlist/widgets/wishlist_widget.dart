...
class WishListWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return wishlistModel?.productFullInfo?.productType == "ad"
        ? Container(
                    ...
                    children: [
                      ...
                      Text(
                        "Updated at".translate(context) +
                            " " +
                            " ${DateTime.tryParse(wishlistModel?.productFullInfo?.createdAt ?? "")?.format()}",
                        style: textStyle(12).copyWith(color: UiColors.medGrey),
                        textAlign: TextAlign.center,
                      ),
                      3.height,
                      // Text(
                      //   "${ wishlistModel?.productFullInfo?.views}" +
                      //       " " +
