...
class ReviewSection extends StatelessWidget {
  ...
  const ReviewSection({super.key, required this.productDetailsModel});
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
          ...
          Container(
              ...
              child: Row(
                  ...
                  children: [
                    RatingBar(
                      rating: double.parse(productDetailsModel!.averageReview!),
                      size: 18,
                    ),
                    const SizedBox(width: Dimensions.paddingSizeDefault),
                    Text(
                        '${double.parse(productDetailsModel!.averageReview!).toStringAsFixed(1)} ${getTranslated('out_of_5', context)}',
