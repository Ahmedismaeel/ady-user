...
import 'package:flutter_sixvalley_ecommerce/features/product_details/widgets/different_seller_valdiation.dart';
                                                ...
                                                if (stock! <
                                                  ...
                                                  Provider.of<CartController>(
                                                    ...
                                                    if (value.response
                                                      ...
                                                      confirmRemove(
                                                          onYes: () async {
                                                        final isRemoved = await Provider
                                                                .of<CartController>(
                                                                    context,
                                                                    listen:
                                                                        false)
