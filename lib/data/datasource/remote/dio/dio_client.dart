...
class DioClient {
  ...
  init() {
    token = SharedPreferenceHelper.instance.getToken();
    countryCode = SharedPreferenceHelper.sharedPreference
            .getString(AppConstants.countryCode) ??
    ...
    dio
      ...
      ..options.headers = {
        ...
        AppConstants.langKey: countryCode == 'US'
            ? 'en'
            : countryCode == 'SA'
                ? 'om'
  ...
  Future<Response> get(
    ...
    // "request body $data".log();
    // "${uri}".log();
    // "${dio?.options.headers}".log();
    try {
